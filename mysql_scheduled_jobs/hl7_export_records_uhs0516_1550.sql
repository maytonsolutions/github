...
BEGIN
        ...
        UPDATE LOW_PRIORITY hl7app.adt_msg_queue_uhs0516
        ...
        UPDATE LOW_PRIORITY hl7app.adt_msg_queue_uhs0516 amq
        INNER JOIN (
            select adt.visit_number, MAX(adt.system_timestamp) as maxTS from adt_msg_queue_uhs0516 adt
        ...
        AND amq.visit_number in (
            ...
            FROM (
                ...
                FROM hl7app.adt_msg_queue_uhs0516 mq
        ...
        UPDATE hl7app.adt_msg_queue_uhs0516
