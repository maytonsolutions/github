...
CREATE EVENT hl7_export_records_centra_1635
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-03-20 21:35:00'
...
BEGIN
        ...
        UPDATE LOW_PRIORITY hl7app.adt_msg_queue_centra
		SET processing_status= 'p'
		WHERE processing_status = 'r'
        AND customer_id = 'CENTRA'
        AND msg_type = 'A03'
        ...
        ," into outfile 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/CENTRA_HL7_"
