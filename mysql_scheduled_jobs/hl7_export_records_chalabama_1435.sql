...
CREATE EVENT hl7_export_records_chalabama_1435
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-05-29 19:35:00'
...
BEGIN
        ...
        SELECT '1' INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/CHALABAMA.OK';
