...
CREATE EVENT hl7_export_records_OSU0523P2_1540
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-01-18 20:40:00'
...
BEGIN
        ...
        INNER JOIN (
            select adt.visit_number, MAX(adt.system_timestamp) as maxTS from adt_msg_queue_osu0523 adt
        ...
        ," into outfile 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/OSU0523P2_HL7_OP"
