...
CREATE EVENT hl7_export_records_duncan_0920
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-06-02 14:20:00'
...
BEGIN
        ...
        ," into outfile 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/DUNCAN_HL7_"
        ...
        select '1' INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/DUNCAN.OK';
