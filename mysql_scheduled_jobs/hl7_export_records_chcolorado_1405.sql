...
CREATE EVENT hl7_export_records_chcolorado_1405
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-05-29 19:05:00'
...
BEGIN
        ...
        ," into outfile 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/CHCOLORADO_HL7_"
        ...
        SELECT '1' INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/CHCOLORADO.OK';
