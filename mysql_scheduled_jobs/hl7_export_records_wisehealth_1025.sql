...
CREATE EVENT hl7_export_records_wisehealth_1025
    ON SCHEDULE
      EVERY 1 day
      STARTS '2018-05-04 15:25:00'
...
BEGIN
        ...
        INNER JOIN (
            select adt.visit_number, MAX(adt.system_timestamp) as maxTS from adt_msg_queue_wisehealth adt
